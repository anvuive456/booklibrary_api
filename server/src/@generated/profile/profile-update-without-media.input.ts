...
import { AddressUpdateOneWithoutProfileNestedInput } from '../address/address-update-one-without-profile-nested.input';

@InputType()
export class ProfileUpdateWithoutMediaInput {
    ...
    @Field(() => AddressUpdateOneWithoutProfileNestedInput, {nullable:true})
