...
import { CategoryOrderByWithRelationAndSearchRelevanceInput } from './category-order-by-with-relation-and-search-relevance.input';
...
export class FindManyCategoryArgs {
    ...
    @Field(() => [CategoryOrderByWithRelationAndSearchRelevanceInput], {nullable:true})
